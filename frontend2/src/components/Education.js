...
function Education({education}) {
    return (
    <div id="education" className=' sm:pl-[8rem] p-8 mx-7 mt-4 sm:mt-0 sm:pt-16 pb-20 sm:px-4 sm:py-0'>
      <div>
      ...
      {education.map(e => (
        ...
        <div className='flex flex-col sm:flex-row gap-10 ml-4 w-full'>
          <div className='text-lg mb-2 ml-[-3px] mt-[0.1rem]'>
            <h1 className='flex-1 min-w-[120px] sm:min-w-[92px]'>{e.degree}</h1>
            <h3 className='text-sm text-center my-1 dark:text-[#ccc]'>{e.years}</h3>
          </div>
